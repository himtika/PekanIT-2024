                        ...
                        <div>
                          ...
                          <div className="mb-10">
                            ...
                            <p className="text-gray-500 dark:text-gray-400">
                              ...
                              <br />
                              088709763493 (Bintang) <br />
                              085719578343 (Meissy) <br />
                              Atau bisa join grup whatsapp dibawah ini : <br />
                              <a
                                href="https://chat.whatsapp.com/GKvGvngoqSWIXYn8ZSrRhF"
                                target="_blank"
                                className="outline-0 text-blue-500"
                              >
                                Click this link !
                              </a>
                            </p>
