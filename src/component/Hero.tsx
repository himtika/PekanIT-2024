    ...
    <>
      ...
      >
        <div className="xl:m-auto lg:m-auto md:m-auto sm:my-[4vh]">
          ...
          <div className="xl:text-center animate-fade-in-2.5s sm:mb-5 sm:text-justify break-words max-w-2xl lg:text-center md:text-center px-5 sm:text-sm md:text-lg mx-auto mt-10 flex justify-center">
            <br />
            <Link
              key="start"
              to="event"
